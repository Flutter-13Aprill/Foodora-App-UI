...
class SignInScreen extends StatelessWidget {
   ...
   Stack(
    ...
    Positioned(
       ...
       left: 80,
        ...
        decoration: BoxDecoration(
          ...
          child: Padding(
            ...
            child: Text("Log in", style: GoogleFonts.poppins(fontSize: 12, fontWeight: FontWeight.w400, color: Color(0XFFFF0036))),
          ),
        ),),
        Positioned(
          top: 280,
          ...
          child:Container(
            ...
            child: Center(child: Text("Sign Up", style: GoogleFonts.poppins(fontSize: 12, fontWeight: FontWeight.w600, color: Colors.white,))),
          ),),
          Positioned(
            top: 370,
            left: 70,
     ...
     Positioned(
      ...
      top: 465,
       left: 70,
      child: Text("confirm Password", style: GoogleFonts.poppins(fontWeight: FontWeight.w400, fontSize: 12, color: Color(0XFFA8A7A7))),),
      Positioned(
        top: 510,
        left:70,
  ...
  MaterialPageRoute(builder: (context) => HomeScreen()),
         ...
         child: Center(child: Text("sign up", style: GoogleFonts.poppins(fontWeight: FontWeight.w600, fontSize: 14, color: Colors.white)))) ),
